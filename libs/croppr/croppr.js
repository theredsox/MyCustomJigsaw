...
var CropprCore = function () {
  ...
  createClass(CropprCore, [{
    ...
    value: function createDOM(targetEl) {
      ...
      this.imageEl.className = 'croppr-image ' + targetEl.className;
      this.imageClippedEl = this.imageEl.cloneNode();
      this.imageClippedEl.className = 'croppr-imageClipped ' + targetEl.className;
    ...
    value: function initializeBox(opts) {
      ...
      var minWidth = opts.minSize.width;
      var minHeight = opts.minSize.height;
      if (opts.minSize.unit === "%") {
        var parentWidth = this.cropperEl.offsetWidth;
        var parentHeight = this.cropperEl.offsetHeight;
        minWidth = parentWidth * (width/100);
        minHeight = parentHeight * (height/100);
      }
      var maxWidth = opts.maxSize.width;
      var maxHeight = opts.maxSize.height;
      if (opts.minSize.unit === "%") {
        var parentWidth = this.cropperEl.offsetWidth;
        var parentHeight = this.cropperEl.offsetHeight;
        maxWidth = parentWidth * (width/100);
        maxHeight = parentHeight * (height/100);
      }
      box.constrainToSize(maxWidth, maxHeight, minWidth, minHeight, [0.5, 0.5], opts.aspectRatio);
      var parentWidth = this.cropperEl.offsetWidth;
      var parentHeight = this.cropperEl.offsetHeight;
    ...
    value: function parseOptions(opts) {
      ...
      if (opts.maxSize !== undefined && opts.maxSize !== null) {
        maxSize = {
          width: opts.maxSize['width'] || null,
          height: opts.maxSize['height'] || null,
          unit: opts.maxSize['unit'] || 'px'
        };
      }
      var minSize = null;
      if (opts.minSize !== undefined && opts.minSize !== null) {
        minSize = {
          width: opts.minSize['width'] || null,
          height: opts.minSize['height'] || null,
          unit: opts.minSize['unit'] || 'px'
        };
      }
      var startSize = null;
      if (opts.startSize !== undefined && opts.startSize !== null) {
        startSize = {
          width: opts.startSize['width'] || null,
          height: opts.startSize['height'] || null,
          unit: opts.startSize['unit'] || '%'
        };
      }
